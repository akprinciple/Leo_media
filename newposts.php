...
<body>
	<div class="card">
		...
		<div class="card-body p-0 m-0">
			...
			<a href="addpost.php" class="float-right"><button class="btn btn-success font-weight-bold mb-2">Add post <i class=" fas fa-plus-circle ml-2"></i> </button></a>
			<div class="clearfix"></div>
		<!------------ For Super Admin------- -->
	

		<?php if ($r['roles'] == "Super Admin") {
			?>
		...
		<tr>
			<td>
				<a href="profile.php?user=<?php echo $_SESSION['id']; ?>" class="font-weight-bold"><?php echo $username; ?></a>
			</td>
			<!--------------------- Title  ----------->
			...
			<td>
				...
				<!----------- Edit Button  --------------->
				<a title="Edit post" class="fas fa-pen text-decoration-none text-secondary" onclick="location.href='editpost.php?edit=<?php echo $row["id"]; ?>'" href="javascript:void(0)">
				</a>
	...
	<!--------------------------- Delete Button  ---------------------------------->
				<a title="Delete" href="deletepost.php?delete=<?php echo $row['id']; ?>" class="fas fa-times ml-3 text-danger text-underline_none"></a>
			</td>
				<!--------------------------- Date  ---------------------------------->
...
// ----------- For Admin 1----------------
	if ($r['roles'] == "admin") {
	?>
	<table class="table table-bordered table-striped text-center table-bordered">
	<thead>
		<tr>
			<th>Author</th>
			<th>Title</th>
	...
	<?php 
		...
		<!------------- Approval Button  --------------------->
		<a class="text-decoration-none"  onclick="location.href='approval.php?approve=<?php echo $row["id"]; ?>'" href="javascript:void(0)" title="<?php if($row['status'] == 1){
			 	echo "Approved";
		}
		else{
		echo "Unapproved";
...
?>
    ...
    <?php if($page_no < $total_no_of_pages){
		...
		<li class="nav-link border border-secondary p-1 font-weight-bold ml-3"><?php $try = "SELECT * FROM `post`";
