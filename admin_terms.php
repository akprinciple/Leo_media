<?php
            ...
            if (isset($_POST['submit'])) {
                ...
                $date = date('D d M Y');
                $update = "UPDATE pages SET content = '{$content}', date = '{$date}' WHERE page_title = 'terms'";
...
<div>
<input type="text" name="title" disabled="disabled" class="form-control" value="Terms & Conditions">
</div>
</div>
