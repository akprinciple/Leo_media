...
<div class="row">
	...
	<h4 class="font-weight-bold pl-3 pt-2 border-bottom mb-3">Contact Us</h4>
...
<div class="clearfix"></div>
	...
	<form method="post" enctype="multipart/form-data">
		<div class="form-group">
			...
			<div>
				<input type="text" name="title" disabled="disabled" class="form-control" value="Contact Us">
			</div>
		</div>

		<div class="mt-3">
			<label class="font-weight-bold">Page Details</label>
			<textarea class="summernote form-control" name="content" id="area">
                    <?php
    $sql = "SELECT * FROM pages WHERE page_title = 'contact us'";
    $query = mysqli_query($connect, $sql);
    while ($row = mysqli_fetch_array($query)) {
