<?php
            ...
            if (isset($_POST['submit'])) {
                ...
                $date = date('D d M Y');
                $update = "UPDATE pages SET content = '{$content}', date = '{$date}' WHERE page_title = 'privacy'";
...
<div class="float-right mb-2">
  <b> Last update:</b> <?php
$sql = "SELECT * FROM pages WHERE page_title = 'privacy'";
...
<div>
<input type="text" name="title" disabled="disabled" class="form-control" value="Privacy and Policy">
</div>
</div>
